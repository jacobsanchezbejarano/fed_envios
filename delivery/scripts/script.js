        ...
        .then(data => {
            ...
            data.forEach(ubicacion => {
                ...
                var marker = L.marker([ubicacion.pedido_latitud, ubicacion.pedido_longitud], { icon: customIcon })
                    ...
                    '<br><a target="_blank" href="https://wa.me/591'+ ubicacion.pedido_celular+'"><button style="background-color:#25d366; color:#fff;padding: 5px;border-radius:10px">Celular: '+ ubicacion.pedido_celular+'</button></a>'+
                    '<br><br>' + boton
                    );
            });
